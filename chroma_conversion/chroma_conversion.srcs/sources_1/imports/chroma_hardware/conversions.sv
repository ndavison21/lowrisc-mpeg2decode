...
module yuv444toRGB (
    ...
    logic to_convert_0, to_convert_1, to_clamp_0, to_clamp_1, locked;
    logic t_last_latch;
    ...
    always_ff @(posedge clk or negedge rst) begin
        if(!rst) begin
            ...
            if (!src.t_valid || !dst.t_ready) begin
                ...
                if (to_convert_0) begin
                    dst.t_data[ 7: 0] <= r_0 > 255 ? 255 : r_0;
                    dst.t_data[15: 8] <= g_0 > 255 ? 255 : g_0;
                    dst.t_data[23:16] <= b_0 > 255 ? 255 : b_0;
                    dst.t_data[31:24] <= 8'b0;
                ...
                if (to_convert_1) begin
                    dst.t_data[39:32] <= r_1 > 255 ? 255 : r_1;
                    dst.t_data[47:40] <= g_1 > 255 ? 255 : g_1;
                    dst.t_data[55:48] <= b_1 > 255 ? 255 : b_1;
